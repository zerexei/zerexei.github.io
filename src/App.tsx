          ...
          <Switch>
            <Route exact path="/">
              ...
              <section className="py-6">
                <h2 className="mb-6 text-4xl text-center uppercase">
                  my top projects
                </h2>
                ...
                <div className="flex justify-center flex-wrap">
                  <div className="bg-white p-4">
                    ...
                    <p className="mb-6 text-sm tracking-wider text-gray-900">
                      Simple php laravel like framework w/ Router and Database
                      support.
                    </p>
                  ...
                  <div className="bg-white p-4">
                    ...
                    <p className="mb-6 text-sm tracking-wider text-gray-900">
                      ...
                      Fugit veniam commodi quam earum perferendis similique
                      saepe asperiores? Quos excepturi rem, vero, quod eligendi,
                      repudiandae earum accusantium magnam recusandae veritatis
                      nostrum.
                    </p>
                    <div className="flex items-center justify-between pb-6">
                      <div className="flex-1 flex flex-wrap gap-1 text-xs">
                  ...
                  <div className="bg-white p-4">
                    ...
                    <p className="mb-6 text-sm tracking-wider text-gray-900">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Maiores illum optio cupiditate iusto quos distinctio
                      dolores eius porro exercitationem ex magnam quas rem,
                      culpa deserunt, quia possimus dignissimos voluptatibus
                      aut!
                    </p>
                    <div className="flex items-center justify-between pb-6">
                      <div className="flex-1 flex flex-wrap gap-1 text-xs">
