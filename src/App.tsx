        ...
        <div className="flex">
          ...
          <section className="flex-1 text-center md:text-left">
            <header className="mb-4">
              <div className="mb-2">
                <h2 className="text-gray-800 text-4xl font-bold mb-px">
                  Angelo Arcillas
                </h2>
                <h3 className="text-primary--dark text-2xl md:text-base">
                  Web Developer
                </h3>
              </div>
              <div className="hidden md:block border-primary border-b-2 border-t w-32 md:w-40 rounded"></div>
            </header>
            <p className="text-gray-900 mb-6">
              Heya I'm Daaave, a web developer with{' '}
              <span className="highlight">
                6+ years experience writting Javascript, PHP &amp; SQL with some
                knowledge in linux server administration
              </span>
              . I specialize in building web apps using frameworks like{' '}
              <span className="highlight">
                Tailwindcss, React.js, vue.js, Laravel and GO
              </span>
              . I am an aspiring senior web developer from philippines who loves
              back-end development,{' '}
              <span className="highlight">
                I always prioritize in best practices and security to ensure
                that I can produce a high quality and secure codebase for
                problem solutions
              </span>
              . I enjoy watching anime, playing pc games and PROGRAMMING.
            </p>

            <p className="text-gray-900 mb-6">
              If you're interested in hiring me check out my{' '}
              <a href="#a">resume</a> and you can contact me through my{' '}
              <a href="#a">email</a>. I am currently looking for web dev
              freelance projects.
            </p>
